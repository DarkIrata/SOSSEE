    ...
    public partial class ItemEditingForm : Form
    {
        ...
        public ItemEditingForm()
        {
            ...
            containers = new ItemContainer[] {
                new ItemContainer { Offset = 0x1A4C, Count = MaxBagItem, Items = null, ContainerDataGridView = bagDataGridView, Tab = bagTab },
                new ItemContainer { Offset = 0x1EFC, Count = MaxContainerItem, Items = null, ContainerDataGridView = toolboxDataGridView, Tab = toolboxTab },
                new ItemContainer { Offset = 0x4DD0, Count = MaxContainerItem, Items = null, ContainerDataGridView = fridgeDataGridView, Tab = fridgeTab },
                new ItemContainer { Offset = 0x7CA4, Count = MaxContainerItem, Items = null, ContainerDataGridView = storageDataGridView, Tab = storageTab },
                new ItemContainer { Offset = 0xAB78, Count = MaxContainerItem, Items = null, ContainerDataGridView = materialDataGridView, Tab = materialTab },
                new ItemContainer { Offset = 0xDA4C, Count = MaxContainerItem, Items = null, ContainerDataGridView = wardrobeDataGridView, Tab = wardrobeTab }
            };
